...
import { endOfDay, getUnixTime, startOfDay, differenceInDays, differenceInMinutes } from 'date-fns';
...
export const getMinutesDifferenceFromNow = (now, timestampInSeconds) => {
  const date = new Date(timestampInSeconds * 1000);
